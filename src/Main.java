...
public class Main {
  ...
  public static void main(String[] args) {
    // TODO 自动生成的方法存根
    ArrayList<Document> doc_list = Document.LoadCorpus("f:/workspace/hello world/livingshow/data/comments_filterlow.txt");
//    int num_longdoc = 500;
